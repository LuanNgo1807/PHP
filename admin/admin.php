...
<div id="wapper">
	<div id="header">
		...
		<div id="bg-header1">
			<img src="../img/bg-header1.png" alt="background" width="1000" height="150">
		</div><!-- End .bg-header -->
	</div><!-- End .header -->
	<div id="content">
		<div id="top-content">
						<p>Chào bạn <fontstyle color="green"><b><u><?= $_SESSION['username']?></u></b></fontstyle><a href="logout.php"> | Thoát</a></p>
		</div>
		<div id="main-content">
			<div id="left-content">
				<div class="danhmucsp">
