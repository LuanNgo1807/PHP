...
?> <?php  echo number_format($tongtien,"0",",",".");?> VNĐ
				...
				<div id="yahoo">
					<div class="center1">
						<h4>HOTLINE</h4>
						<h2><a href="ymsgr:sendim?anhchanglangtu_yeubetocvang&amp;m=g&amp;t=14"><img src="img/online.png"></a></h2>
							<p>Liên hệ: 099999999</p>
						<h2><a href="ymsgr:sendim?boydangyeu8188&amp;m=g&amp;t=14"><img src="img/online.png"></a></h2>
							<p>Liên hệ: 099999999</p>
					</div><!-- End .center1-->
				</div><!-- End .yahoo -->
				...
				<div id="fb-root">
					<div class="center1">
						...
						<div class="fb-like-box" data-href="https://www.facebook.com/luanngodinh1807/" data-width="188" data-colorscheme="light" data-show-faces="true" data-header="true" data-stream="false" data-show-border="false"></div>
					</div><!-- End .center1 -->
				</div><!-- End .facebook -->