...
<table>
	...
	/*------------Phan trang------------- */
		...
		$sql = mysqli_query($conn,"SELECT * FROM sanpham inner join danhmuc on sanpham.madm=danhmuc.madm ORDER by idsp DESC  LIMIT $from, $max_results"); 
...
?>
	...
	<?php
			...
			$results = mysqli_query($conn,"SELECT COUNT(*) as Num FROM sanpham");  
