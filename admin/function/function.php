...
function taomadm($bang,$truongma,$kytudungdau='')
{
	...
	$result = mysqli_query($conn,$sql,$link);
...
echo header("Refresh: $delay; URL=$url");
...
require("dbcon.inc");
	...
	if($value_ma2<>"")
		$where=" and $field_dieukien2='$value_ma2'";
	
$sql___="SELECT $field_ten FROM $table WHERE $field_ma='$value_ma' $where";
//echo $sql___;
$result=mysqli_query($conn,$sql,$link);
