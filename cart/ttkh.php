...
<form action="index.php?content=cart&action=insert" method="POST" id="a" onsubmit="return kiemtra();">
    <table>
        ...
        if (isset($_SESSION['idnd'])) {
            ...
            if ($row) {
                ?>
                <tr><td colspan="2" text-align="center" style="">Thông tin khách hàng</td></tr>
                ...
                <!-- <tr><td class="tieude">Ngày nhận: </td><td><input type="date" name="ngaynhan" value="<?php echo $row['ngaynhan'] ?>"/></td></tr> -->
                <tr><td colspan="2" text-align="center" style="">Phương thức thanh toán</td></tr>
