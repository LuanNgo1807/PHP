			...
			<div class="preload"><div></div></div>
				<div id="lof-main-outer">
					<ul class="lof-main-wapper">
						<li><img src="img/slide/banner.png" width="1000" height="350"></li>
						<li><img src="img/slide/banner1.png" width="1000" height="350"></li>
						<li><img src="img/slide/banner2.png" width="1000" height="350"></li>
						<li><img src="img/slide/banner3.png" width="1000" height="350"></li>
						<li><img src="img/slide/banner4.png" width="1000" height="350"></li>
					</ul>
				</div>
					...
					<div onClick="return false" href="" class="lof-next">Next</div>
					  <div class="lof-navigator-outer">
							<ul class="lof-navigator">
							   <li><img src="img/slide/banner.png" width="70" height="25" /></li>       		
							   <li><img src="img/slide/banner1.png" width="70" height="25" /></li>       		
							   <li><img src="img/slide/banner2.png" width="70" height="25" /></li>       		
							   <li><img src="img/slide/banner3.png" width="70" height="25" /></li>       		
							   <li><img src="img/slide/banner4.png" width="70" height="25" /></li>       		
							</ul>
					  </div>
					...
					<div class="boxeSlide" style="overflow:hidden;">
							<div class="sildeShow">
								<ul id="random">
									...
									<li> 
										<a href="#"><img src="img/iphone.png" alt="Sam Sung" title="Sam Sung" /></a>
									</li>
										<li> 
	...
	<div id="footer">
		...
		<div id="bg-footer">
			<div id="noidungfooter">
				...
				<div id="noidung">
					<ul>
						<li><span id="tencongty">Công Ty TNHH ĐIỆN THOẠI LOKI</span></li> <br>
						
						<li>Địa chỉ: Bắc Từ Liêm - Hà Nội </li>
						<li>Điện thoại: 099999999 - Hotline:  099999999</li>
						<li>Email:  dienthoailoki@gmail.com</li>
					</ul>
				</div><!-- End .noidung -->
				<div id="thanhngang">
